...
export const Card = ({
  ...
  <motion.div
    ...
    className={cn(
      "bg-surface border border-neutral-800 p-6 rounded-none shadow-lg",
      className,
    )}
    {...props}
  >
...
export const Badge = ({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center px-2 py-1 text-xs font-medium border rounded-none uppercase tracking-wider",
        variants[variant],
        className,
      )}
    >
